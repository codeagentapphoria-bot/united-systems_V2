...
import { Image, Upload, X, Camera, PawPrint } from "lucide-react";
import { handleError } from "@/utils/errorHandler";

const PetImageForm = ({ pet, onSubmit, onCancel, loading = false }) => {
  ...
  // Set initial image preview if pet has an image
  useEffect(() => {
    if (pet?.picture_path) {
      setImagePreview(pet.picture_path);
    }
  }, [pet]);
