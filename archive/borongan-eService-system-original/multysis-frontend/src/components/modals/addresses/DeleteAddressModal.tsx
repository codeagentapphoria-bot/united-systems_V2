      ...
      <DialogContent className={cn('max-w-md')}>
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3 p-4 rounded-lg border bg-red-50 border-red-200">
            ...
            <div>
              <p className="font-medium text-red-900">Address Information</p>
              <p className="text-sm text-red-700">{addressLabel}</p>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500">
              This action cannot be undone. The address will be permanently removed from the system.
            </p>
            <p className="text-sm text-red-600 font-medium mt-2">
              Note: Addresses that are in use cannot be deleted.
            </p>
          </div>
