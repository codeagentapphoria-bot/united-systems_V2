...
interface RemoveCitizenModalProps {
  open: boolean;
  onClose: () => void;
...
export const RemoveCitizenModal: React.FC<RemoveCitizenModalProps> = ({
  open,
  onClose,
  onConfirm,
  citizenName,
      ...
      <DialogContent className={cn("max-w-md")}>
        <DialogHeader>
          ...
          <DialogDescription className="text-gray-600 mt-2">
            Are you sure you want to remove <span className="font-bold text-red-700">{citizenName}</span>?
