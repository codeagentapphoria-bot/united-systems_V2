      ...
      <DialogContent className={cn("max-w-md")}>
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3 p-4 rounded-lg border bg-red-50 border-red-200">
            ...
            <div>
              <p className="font-medium text-red-900">Service Information</p>
              <p className="text-sm text-red-700">{serviceName}</p>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-red-600 font-medium mt-2">
              Note: Services with existing transactions cannot be deleted.
            </p>
          </div>
